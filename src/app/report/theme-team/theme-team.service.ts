...
export class ThemeWiseTeamService {
  private apiUrl = 'https://en-backend.onrender.com/api/v1/reports/partner-theme-wise-school-dist/';
   ...
   */
  getThemeWise(districtId?: string | null): Observable<any> {
