...
export class OverallSubmissionsService {
  private apiUrl = 'https://en-backend.onrender.com/api/v1/reports/partner-school-submission-stats/';
   ...
   */
  getOverallSubmissions(districtId?: string | null): Observable<any> {
