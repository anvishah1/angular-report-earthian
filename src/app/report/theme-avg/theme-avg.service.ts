...
export class ThemeAvgService {
  private apiUrl = 'https://en-backend.onrender.com/api/v1/reports/partner-theme-score-stats/';
   ...
   */
  getThemeAvg(districtId?: string | null): Observable<any> {
